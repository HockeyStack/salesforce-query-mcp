  ...
  apps: [
    {
      ...
      // Log locations
      out_file: "/var/log/revops-mcp/mcp-server.out.log",
      error_file: "/var/log/revops-mcp/mcp-server.err.log",
      merge_logs: true,
    ...
    },
    {
      ...
      restart_delay: 2000,
      exp_backoff_restart_delay: 100,
      out_file: "/var/log/revops-mcp/slack-bot.out.log",
      error_file: "/var/log/revops-mcp/slack-bot.err.log",
      merge_logs: true,
      log_date_format: "YYYY-MM-DD HH:mm:ss Z",
    },
  ],
